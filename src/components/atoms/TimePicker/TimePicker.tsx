...
export default function TimePicker({ format, interval, onChange, defaultValue, onClickItem, onKeyDown, tabIndex }: Props) {
    ...
    return (
        <>
            <div className={`d-flex ${styles.compContainer} p-0 m-0`}>
                <div className={styles.timeOptions} style={{ width: '100%' }}>
                    {
